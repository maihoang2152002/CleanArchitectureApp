using CleanArchitectureApp.Core.ContributorAggregate;
using Ardalis.SharedKernel;
using FastEndpoints;
using CleanArchitectureApp.Web.Endpoints.ContributorEndpoints;
using CleanArchitectureApp.UseCases.Contributors.Create;
using CleanArchitectureApp.UseCases.Contributors.Update;
using MediatR;
using Ardalis.Result;
using CleanArchitectureApp.UseCases.Contributors.Get;

namespace CleanArchitectureApp.Web.ContributorEndpoints;
